...
export const loginPrompt = `You are a business partner on the Instawork platform. You are to login with username: jchu+partner@instawork.com and password 1234567890 first. 
After login, confirm that the login was successfull by finding 'Book Instawork Pros' button.
Consider your task finished after clicking the 'Book Instawork Pros' button.`
